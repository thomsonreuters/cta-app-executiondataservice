...
class UpdateState extends BaseHelper {
  ...
  _onUpdateExecution(context, nonUpdatedExecution, updatedExecution) {
    ...
    getInstancesStatesContext.on('done', function (brickName, instancesStates) {
      that._onGetInstancesStates(context, nonUpdatedExecution, updatedExecution, instancesStates);
    });
  ...
  _onGetInstancesStates(context, nonUpdatedExecution, updatedExecution, instancesStates) {
    ...
    const allHaveAnswered = _.isArray(updatedExecution.instances) && updatedExecution.instances.length === instancesStates.length;
