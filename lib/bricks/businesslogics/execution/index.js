...
const UpdateStatusesCountHelper = require('./helpers/updatestatusescount');
...
class Execution extends Base {
  constructor(cementHelper, configuration) {
    ...
    this.helpers.set('updatestatusescount',
      new UpdateStatusesCountHelper(this.cementHelper, this.logger));
  }
}
