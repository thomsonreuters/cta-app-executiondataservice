...
const State = require('../../datamodels/states.js');

/**
 * Handler class for RESTAPI handlers : STATES
...
class StatesHandler {
  ...
  constructor(cementHelper) {
    ...
    this.dataType = 'states';
  }

  /**
   * Publishes request body (State) in an state-create Context
   * @param req
   * @param res
   * @param next
   */
